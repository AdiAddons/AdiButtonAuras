...
* @model@ is a table containing the data to display on the spell. The handler should update its attributes (see below). It may contains values from previous handlers.
